              ...
              <div className="group relative rounded-3xl overflow-hidden h-[400px] border border-white/10 shadow-2xl">
                ...
                {project.badge && (
                  <div className="absolute top-4 left-4 right-4 z-20">
                    <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-slate-900/80 backdrop-blur-md border border-emerald-500/30 text-emerald-400 text-[10px] md:text-xs font-bold shadow-lg">
                      <Tag size={12} className="text-emerald-500" />
                      <div className="flex flex-col leading-none gap-0.5">
                        <span>{project.badge.zh}</span>
                        <span className="opacity-70 font-normal">{project.badge.en}</span>
                      </div>
                    </div>
                  </div>
                )}
